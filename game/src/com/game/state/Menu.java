...
public class Menu extends State {
    ...
    public void render(Graphics2D g2d) {
        ...
        Sprite.drawFont(g2d, font, "Play", new Vector2f((float) panel.getWidth() / 2 - 41, 270), 32, 32, 14, 0);
        //g2d.drawRect(panel.getWidth() / 2 - 41, 270, 56, 32);

        Sprite.drawFont(g2d, font, "Hiscores", new Vector2f((float) panel.getWidth() / 2 - 70, 335), 32, 32, 14, 0);
        Sprite.drawFont(g2d, font, "Options", new Vector2f((float) panel.getWidth() / 2 - 60, 400), 32, 32, 14, 0);
        Sprite.drawFont(g2d, font, "Exit", new Vector2f((float) panel.getWidth() / 2 - 41, 465), 32, 32, 14, 0);
