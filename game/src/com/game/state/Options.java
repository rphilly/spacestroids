...
public class Options extends State {
    ...
    public void render(Graphics2D g) {
        uiManager.render(g);
        Sprite.drawArray(g, font, "OPTIONS", new Vector2f((float) panel.getWidth() / 2 - 190, 100), 48, 48, 22, 0);
        Sprite.drawArray(g, font, "Controls", new Vector2f((float) panel.getWidth() / 2 - 41, 270), 32, 32, 14, 0);
        Sprite.drawArray(g, font, "FPS toggler", new Vector2f((float) panel.getWidth() / 2 - 70, 335), 32, 32, 14, 0);
        Sprite.drawArray(g, font, " ", new Vector2f((float) panel.getWidth() / 2 - 60, 400), 32, 32, 14, 0);
        Sprite.drawArray(g, font, "Back", new Vector2f((float) panel.getWidth() / 2 - 41, 465), 32, 32, 14, 0);
    }
}
